...
namespace ichol
{
    ...
    DenseMatrix csr_to_dense(const CSR<double> &csr)
    {
    ...
    double residual_l2_norm(const CSR<double> &A, const CSR<double> &L)
    {
        auto has_bad = [](const ichol::CSR<double> &M)
        {
    ...
    double l2_norm(const CSR<double> &mat)
    {
        double sum_sq = 0.0;
